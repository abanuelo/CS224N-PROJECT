...
BiLSTM-CRF.py
-----------------------
This file contains the constructor for the the BiLSTM-CRF model as well as accompanying funtions

Modified from code by Robert Guthrie.
...
def prepare_sequence(seq, to_ix):
    """
    convert sequence of characters to integers using dictionaries
